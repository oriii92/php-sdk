...
class MerchantOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'data' => MerchantOrderResponseData::class,
    ];
     ...
     * Gets data
     *
     * @return ?MerchantOrderResponseData
     */
    public function getData(): ?MerchantOrderResponseData
    {
     ...
     * Sets data
     *
     * @param ?MerchantOrderResponseData $data
     *
     * @return self
     */
    public function setData(?MerchantOrderResponseData $data): self
    {
